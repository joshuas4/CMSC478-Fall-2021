...
def plot_data_scatterplot(X, y, thetas=[]):
    ...
    colors = iter(('blue', 'purple', 'orange'))
    contours = []
    for theta, _ in thetas:
        ...
        contours.append(ax.contour(xsgrid, ysgrid, plane,
                                   colors=colors.__next__(), levels=[0]))
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--plot_model', action='store_true', default=False,
                           help='Produce scatterplot with fit contours')
    argparser.add_argument('--plot_data', action='store_true', default=False,
                           help='Produce scatterplot of the data')
